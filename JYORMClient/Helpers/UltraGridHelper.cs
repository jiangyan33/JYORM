...
namespace JYORMClient.Helpers
{
    public class UltraGridHelper
    {
        ...
        private static void SetGridDefaultStyle(UltraGrid grid, UltraGridOptions ultraGridOptions)
        {
            ...
            grid.DisplayLayout.Override.BorderStyleRow = UIElementBorderStyle.WindowsVista;
            grid.DisplayLayout.Override.BorderStyleRowSelector = UIElementBorderStyle.WindowsVista;
            ...
            grid.DisplayLayout.Override.ActiveAppearancesEnabled = DefaultableBoolean.True;
        ...
        private static void SetGridBandDefaultStyle(UltraGridBand band)
        {
            ...
            band.Override.RowSizing = RowSizing.Free;
        ...
        public static UltraGridColumn AddLinkedColumn(UltraGrid grid, string caption, LinkClickedEventHandler clickAction)
        {
    ...
    public class UltraGridDisplayItem : DisplayItem
    {
        ...
        /// 列样式,空值为默认
        /// </summary>
        public Infragistics.Win.UltraWinGrid.ColumnStyle ColumnStyle { get; set; }
    ...
    public class UltraGridOptions
    {
        ...
        /// 是否显示列序号
        /// </summary>
        public DefaultableBoolean RowSelectors { get; set; } = DefaultableBoolean.True;
